...
% PLACEHOLDER: Sinh viên điền kết quả thực nghiệm vào đây

\textit{[Chưa có dữ liệu - cần chạy thực nghiệm và điền kết quả]}
...
% PLACEHOLDER: Sinh viên điền nhận xét vào đây

\textit{[Chưa có dữ liệu - cần phân tích kết quả thực nghiệm]}
